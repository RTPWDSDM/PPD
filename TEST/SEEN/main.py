...
def optimalpathgeneration(path,file,path_binarymap,path_RGBmapwithcoordi,path_RGBmapwithpath,path_onlypath,path_sg_coordinate,path_coordinate,path_cost):
    ...
    while i < 1200:
        ...
        maporiginal = cv2.imread(path+"/{}.jpg".format(j%4000))
...
if __name__==   "__main__":
    path = r'C:\Users\huang\Desktop\OPEN DATASET\DATASET\TEST\SEEN\MAP [ORIGINAL]' # original map
    path_binarymap = r"C:\Users\huang\Desktop\OPEN DATASET\DATASET\TEST\SEEN\MAP [BINARY]" #binary map
    path_RGBmapwithcoordi = r"C:\Users\huang\Desktop\OPEN DATASET\DATASET\TEST\SEEN\MAP [EXAMPLE]" # RGB map with coordinate
    path_RGBmapwithpath = r"C:\Users\huang\Desktop\OPEN DATASET\DATASET\TEST\SEEN\MAP [RESULT]" # RGB map with path
    path_onlypath = r"C:\Users\huang\Desktop\OPEN DATASET\DATASET\TEST\SEEN\PATH [2PIXEL]" # only path
    path_sg_coordinate = r"C:\Users\huang\Desktop\OPEN DATASET\DATASET\TEST\SEEN\COORDINATE [TARGET&GOAL]"
    path_coordinate = r"C:\Users\huang\Desktop\OPEN DATASET\DATASET\TEST\SEEN\COORDINATE [SIGNIFICANT WAYPOINT]"
    path_cost = r"C:\Users\huang\Desktop\OPEN DATASET\DATASET\TEST\SEEN\PATH [COST]"
